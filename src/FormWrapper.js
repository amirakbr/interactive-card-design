               ...
               <div className="grid xsm:grid-cols-1fr1fr gap-[1rem]">
                    <div className="flex flex-col gap-2 text-[1rem] font-bold items-center xsm:items-start">
                         ...
                         <div className="grid grid-cols-1fr1fr gap-[.5rem]">
                              <input onChange={() => {setArr(document.querySelector('.input').value)}} type='text' className="w-full border-[.15rem] rounded-[.5rem]  py-2 px-4 focus:border-[#6f00ff] focus:outline-none focus:ring-0 outline-none input" maxLength='19' placeholder="MM" value={arr} />
